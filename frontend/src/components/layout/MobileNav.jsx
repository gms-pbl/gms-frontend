...
export default function MobileNav({ unackedCriticalCount, onOpenAlerts }) {
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-30 flex items-center justify-around bg-surface border-t border-border h-14 px-4">
      {/* Home */}
      <button className="flex flex-col items-center gap-0.5 text-accent min-w-[44px] min-h-[44px] justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
        </svg>
        <span className="text-[8px] font-mono tracking-widest uppercase">Sensors</span>
      </button>
